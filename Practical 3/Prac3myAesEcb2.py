...
original_text='111111111111111111111111111111111111111111111111111111111111' #Plain text
...
for b in text_in_bytes:
    ...
    ct=ct+1
    if chk_eight(ct): print() #Print a newline

print("\n")#This print another new line

cipher = AES.new(key, AES.MODE_ECB) #New AES cipher using key generated

print(f"len of bytes: {len(text_in_bytes)}")
print (f"len of padded bytes: {len(pad(text_in_bytes,BLOCK_SIZE))}")
